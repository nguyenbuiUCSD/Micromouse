...
#define FL_EM_ON   GPIO_SetBits(GPIOA, GPIO_Pin_2)
#define FL_EM_OFF  GPIO_ResetBits(GPIOC, GPIO_Pin_2)
#define LD_EM_ON   GPIO_SetBits(GPIOC, GPIO_Pin_3)
#define LD_EM_OFF  GPIO_ResetBits(GPIOC, GPIO_Pin_3)
#define RD_EM_ON   GPIO_SetBits(GPIOC, GPIO_Pin_0)
#define RD_EM_OFF  GPIO_ResetBits(GPIOC, GPIO_Pin_0)
